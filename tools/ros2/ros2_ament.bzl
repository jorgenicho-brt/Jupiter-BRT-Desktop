...
load(
    #"//tools/private:ros2_adapter.bzl",
    "//autonomy/jupiter/robotics/jupiter-desktop/tools/ros2:ros2_adapter.bzl",
    "idl_adapter_aspect",
)
load("//autonomy/jupiter/robotics/jupiter-desktop/tools/ros2:ros2_expand_template.bzl", "expand_template_impl")
load(
    #"//tools/private:ros2_plugin_aspects.bzl",
    "//autonomy/jupiter/robotics/jupiter-desktop/tools/ros2:ros2_plugin_aspects.bzl",
...
load(
    ...
    "//autonomy/jupiter/robotics/jupiter-desktop/tools/ros2:ros2_providers.bzl",
...
#load("//tools/private:ros2_expand_template.bzl", "expand_template_impl")
load(
    #"//tools/private:ros2_interfaces.bzl",
    ":ros2_interfaces.bzl",
    #"Ros2InterfaceInfo",
